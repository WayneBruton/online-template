        ...
        <panel title="FAQ">
          <form autocomplete="off">
            <v-flex sm12 offset-xs0>
              ...
              <br>
              <v-textarea label="Narrative" required placeholder="Narrative" v-model="narrative"></v-textarea>
            </v-flex>
          </form>
          <br>
          ...
          <v-btn :class="this.$store.state.siteSetup.color" @click="reset" dark>Reset</v-btn>
        </panel>
        <br>

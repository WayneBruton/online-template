  ...
  <div class="cropper-modal">
    ...
    <div class="modal">
      <div class="modal-head">
        <div class="head-wrap">Add product image (Landscape works best)</div>
      </div>
      <div class="modal-content clearfix">
        <div class="img-clip-wrap">
          ...
          <div class="reset-img">
            <!-- <v-icon class="mr-2" color="green darken-2">cloud_upload</v-icon> -->
            <v-icon class="mr-2" color="green darken-2">present_to_all</v-icon>
      ...
      <div class="modal-footer">
        <a class="modal-btn btn-confirm" :href="clipData" download="cropped.jpg">Download</a>
      </div>
    </div>
  </div>
</template>
